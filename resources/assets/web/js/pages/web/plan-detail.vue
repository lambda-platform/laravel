                ...
                <div class="card">
                    ...
                    <div class="detail-info">
                        <div class="zar-detail">
                            ...
                            <br>
                            <h4>
                                <a :href="`/#/plandownload/${plan.id}`" target="_blank">Файл татах холбоос</a>
                            </h4>
                            <!--<small>{{ plan.aimag }}, {{ plan.soum }}, {{ plan.bag?plan.bag:''}}</small>-->
                            <!--<small>{{ plan.delgerengui }}</small>-->
                        </div>

                        <div class="info-row clearfix">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 info-section" style="padding: 40px">
                                    <h4>Зургийн ерөнхий мэдээлэл</h4>
                                    <table class="table table-striped table-small">
                                        <tbody>
                                        <tr>
                                            <td>Захиалагч</td>
                                            <td>{{ plan.zahialagch_comp }}</td>
                                        </tr>
                                        <tr>
                                            <td>Захиалагч нэр</td>
                                            <td>{{ plan.zahialagch_name }}</td>
                                        </tr>
                                        <tr>
                                            <td>Гүйцэтгэгч</td>
                                            <td>{{ plan.guitsetgegch_comp }}</td>
                                        </tr>
                                        <tr>
                                            <td>Гүйцэтгэгч нэр</td>
                                            <td>{{ plan.guitsetsgegch_name }}</td>
                                        </tr>
                                        <tr>
                                            <td>Үзсэн тоо</td>
                                            <td>{{ plan.viewed }}</td>
                                        ...
                                        <tr>
                                            <td>Татагдсан тоо</td>
                                            <td>{{ plan.downloaded }}</td>
                                        </tr>
                                        <tr>
                                            <td>Файлын төрөл</td>
                                            <td>{{ plan.file_type }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <h4>АОС-ны мэдээлэл</h4>
                                    <table class="table table-striped table-small">
                                        <tbody>
                                        <tr>
                                            <td>Хийц</td>
                                        ...
                                        <tr>
                                            <td>Талбайн хэмжээ</td>
                                            <td>{{ plan.mkv }}мкв</td>
                                        </tr>
                                        <tr>
                                            <td>АЦ өрөөний тоо</td>
                                            <td>{{ plan.ats_uruu }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                this.loading = true;
                axios.post("/getplandetail/" + this.$route.params.id).then(({data}) => {
                    this.plan = data.plan;
