        ...
        <div class="buildingtab">
            ...
            <Tabs :animated="false" size="small" :value="tabname" @on-click="tabclicked">
                <TabPane label="Үндсэн бүртгэл" name="tab1">
                    <dataform ref="form1" class="material-form" :schemaID="tab1schemaid" :editMode="actiontype=='edit'" :onSuccess="onSuccessFirstTab"
...
<script>
    export default {
        ...
        data() {
            return {
                tab1schemaid:this.$user.role==36?316:179,
                iseditmode: false,
                tabname: '',
                tab2: false,
                tab3: false,
        ...
        methods: {
            ...
            onSuccess($data) {
                ...
                //console.log($data);
                //this.$router.push('/building/barilga/createbarilga/edit/'  + this.$props.id+ '/' + this.$props.id);
            },
            tabclicked(tabid) {
                switch (tabid) {
                    case "tab2": {
