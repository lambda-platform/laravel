...
class Barilga extends Model
{
    use SoftDeletes;

    protected $table = 't_barilga';
    ...
    public $zuragCompsTmp = null;
    public $guitsCompsTmp = null;
    public $shineBarilgaTmp = null;
    public $detailTmp = null;
    public $uneTmp = null;
    public $objectsTmp = null;
    ...
    {
        return $this->hasOne(BarilgaDetail::class);
    }
}
